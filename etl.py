...
def main():
    ...
    process_data(cur, conn, filepath='C:\Users\HomePC\Documents\Json file\Song_Data', func=process_song_file)
    process_data(cur, conn, filepath='C:\Users\HomePC\Documents\Json file\Log_Data', func=process_log_file)
